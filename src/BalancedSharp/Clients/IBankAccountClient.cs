...
namespace BalancedSharp.Clients
{
    ...
    {
        Status<BankAccount> New(string name, string accountNumber, string routingNumber, 
    ...
    public class BankAccountClient : IBankAccountClient
    {
        ...
        public Status<BankAccount> New(string name, string accountNumber, string routingNumber, 
            BankAccountType type, Dictionary<string, string> meta = null)
        {
