...
namespace BalancedSharp.Tests.Clients
{
    ...
    public class AccountClientTests
    {
        ...
        {
            this.service.Account.AddCard("TEST-MP6E3EVlPOsagSdcBNUXWBDQ", "AC7D2TvkfsxPmc8VpYQrdmhi", "CC7FHSFn8oRlSJSAjiBpRtLa");
        ...
        {
            this.service.Account.AddBankAccount("TEST-MP6E3EVlPOsagSdcBNUXWBDQ", "AC3z0Z98UsRL1DERqFlb9wu", "BA7IU7MDWuhYHjlDID0WVXG");
        ...
        public void AddBankAccount_BankAccountUri()
        {
            ...
            this.service.Account.AddBankAccount("TEST-MP6E3EVlPOsagSdcBNUXWBDQ", "AC7D2TvkfsxPmc8VpYQrdmhi", "BA7IU7MDWuhYHjlDID0WVXG");
